...
// Tipos primitivos
let identificador = "USR-492";
let iteraciones = 10;
let procesoActivo = true;
// Inferencia
let timestamp = new Date().getTime();
// Arrays
let metricas = [12.4, 8.9, 15.0];
let logs = ["INFO: Inicio", "ERROR: Timeout"];
// Tupla
let coordenadaEspacial = [40.4168, -3.7038, 600];
...
function registrarEvento(mensaje, nivelError = 1, metadatos) {
...
const permisosInmutables = { admin: true, nivel: 1 };
// unknown
...
console.log("Desviación estándar:", calcularDesviacionEstandar(metricas, 12.1));
